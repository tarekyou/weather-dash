            ...
            response.json().then(function(response) {
                ...
                fetch(forecastUrl).then(function(response){
                        response.json().then(function(response){
                            ...
                            upcomingDay1El.textContent =  (moment().add(1, "days"));
                            ...
                            upcomingDay2El.textContent =  (moment().add(2, "days"));
                            ...
                            upcomingDay3El.textContent =  (moment().add(3, "days"));
                            ...
                            upcomingDay4El.textContent =  (moment().add(4, "days"));
                            ...
                            upcomingDay5El.textContent =  (moment().add(5, "days"));
